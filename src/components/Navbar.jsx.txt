...
export default function Navbar() {
  ...
  // زر تبديل الوضع داخل شريط التنقل
  useEffect(() => {
    ...
    >
      ...
      >
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    ...
                    // إصلاح مؤشر الرابط النشط في RTL
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          {/* أزرار اللغة والوضع بنفس الحجم والتأثير */}
          {/* Language Toggle */}
          <button
            onClick={toggle}
          ...
          <button
            ...
            className="flex md:hidden flex-col gap-1.5 p-2 rounded-lg hover:bg-white/5"
          >
            <span
              className={[
                'block h-0.5 w-5 rounded-full bg-slate-300 transition-all duration-300',
      ...
      <div
        className={[
          'md:hidden overflow-hidden transition-all duration-400 border-t border-blue-500/10',
          mobileOpen ? 'max-h-80 bg-navy-900/98 backdrop-blur-md' : 'max-h-0',
        ].join(' ')}
